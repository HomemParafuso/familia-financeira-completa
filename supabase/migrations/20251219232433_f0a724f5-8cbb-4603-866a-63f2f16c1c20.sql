...
CREATE TABLE public.transactions (
    ...
    recurrence_interval INTEGER, -- Para recorrência personalizada (a cada X dias)
    recurrence_start_date DATE,
    recurrence_end_date DATE,
    recurrence_count INTEGER, -- Número de parcelas (para financiamentos)
    parent_transaction_id UUID REFERENCES public.transactions(id) ON DELETE CASCADE,
    recurrence_index INTEGER, -- Índice da parcela atual
    -- Notificações
